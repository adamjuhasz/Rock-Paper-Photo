...
- (void)viewDidLoad {
    ...
    self.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@" "
                                                                            ...
                                                                            target:nil
                                                                            action:nil];
    [self.tableView registerNib:[UINib nibWithNibName:@"ChallengeThemeCell" bundle:nil] forCellReuseIdentifier:@"themeCell"];
}
...
- (PFQuery *)queryForTable {
    ...
    [challengeQuery whereKey:@"expiresAt" greaterThan:[NSDate date]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    ChallengeThemeCell *cell = (ChallengeThemeCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    cell.themeNameLabel.text = object[@"Text"];
    cell.themeImageView.file = object[@"thumbnail"];
    [cell.themeImageView loadInBackground];
    return cell;
}
